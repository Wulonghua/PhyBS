/****************************************************************************
 ...
 Modified On Sept. 4th, 2016 by Longhua Wu
 Update parent class from obsolated class QGLWidget to QOpenGLWidget
...
void setBackgroundColor(const QColor& c) {
	backgroundColor_ = c;  glClearColor((GLfloat)c.red() / 255.0, (GLfloat)c.green() / 255.0,(GLfloat)c.blue() / 255.0, (GLfloat)c.alpha() / 255.0);
}
